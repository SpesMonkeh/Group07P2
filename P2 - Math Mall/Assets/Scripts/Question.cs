...
{
    [TextArea, SerializeField] string info = "Can only be changed programatically";

    [SerializeField] public QuestionType type = QuestionType.NOT_SET;
    [SerializeField] public int typeSpecificIndex = -1;
    [SerializeField] public int globalQuestionIndex = -1;
